<template>
  <div class="ico-marketing">
    <header class="section section--ico-head">
      <router-link class="back-link" to="/">
        &lsaquo; Back to the 6slambo main site
      </router-link>
      <div class="container">
          ...
          <div class="col-sm-6">
            <div class="head-deco">
              ...
              <h1 class="section__lead">
                You mind the product, we’ll do the rest
              </h1>
              <div class="section__subtitle">
                ICO marketing “our way” is simple, painless, and tailored specifically to your needs.
              </div>
            </div>
          </div>
        </div>
        <ul class="list-unstyled text-uppercase">
          <li class="my-3">&check; A hassle-free experience</li>
          <li class="my-3">&check; Buzz about you and your product</li>
          <li class="my-3">&check; Community building and heightened expectations</li>
          <li class="my-3">&check; Educating your audience about why they need your product</li>
          <li class="my-3">&check; Making your offering a guaranteed hit</li>
        </ul>
      </div>
    </header>
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-sm-6 offset-sm-3">
            ...
            <p>
              We are one of the first companies to truly understand and deploy marketing and PR tailored for ICOs and STOs. We have a deep understanding of the shift required when you move from a technical focus to an investor-centric focus. ICO marketing “our way” is simple, painless, and tailored specifically to your needs. You have amazing stories to tell and knowledge to share. Our job is to make sure the right people get the message when and where they need it.
            </p>
            <p class="font-weight-bold">
              With Mate Tokay, COO of Bitcoin.com on board as investor and strategic advisor, you know you are backing the right horse!
            </p>
          </div>
        </div>
      </div>
